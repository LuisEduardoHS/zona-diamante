...
export function renderBottomNav() {
    if (document.querySelector('.site-bottom-nav')) return;
    const base = ruta('');
        ...
        <nav aria-label="Navegación inferior" class="site-bottom-nav fixed bottom-0 left-0 w-full bg-white h-20 rounded-t-3xl z-50">
            ...
            <div class="flex justify-between items-center h-full px-2">
                ...
                <div class="w-1/5 h-full relative">
                    <a href="${base}camara.html" aria-label="Cámara AR" class="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#f27b21] w-[72px] h-[72px] rounded-[1.25rem] flex items-center justify-center shadow-lg">
